...
public class MainActivity extends FragmentActivity {
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			case 3:
				return getString(R.string.group_name).toUpperCase(l);
			}
			return null;
		}
	}
	...
	public static class SectionFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
				...
				createGroupButton.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						Toast.makeText(getActivity(),
								"Starting group. Create some ideas.",
								Toast.LENGTH_LONG).show();
						Intent ideasActivity = new Intent(getActivity(),
								IdeasActivity.class);
						startActivity(ideasActivity);
					}
				});
				/*
				 * ListView groupList = (ListView)
				 * rootView.findViewById(R.id.idea_list); IdeaAdapter
			 ...
			 * container, false); TextView dummyTextView = (TextView)
			 * rootView.findViewById(R.id.section_label);
			 * dummyTextView.setText(Integer
