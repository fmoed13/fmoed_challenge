...
public class CameraActivity extends Activity {
	...
	/**
	 * onCreate event: Initiatialize all the components needed for interaction
	 * with camera API.
	 * 
			...
			public void onClick(View v) {
				...
				if (imageBytes != null) {
					...
					Toast.makeText(getApplicationContext(),
							"Saving photo to Images folder.", Toast.LENGTH_LONG)
							.show();
					;
					...
					Toast.makeText(getApplicationContext(),
							"There's nothing to save", Toast.LENGTH_LONG)
							.show();
					;
				}
			}
	...
	/**
	 * onActivityResult event: When return from camera intent this event gets
	 * executed.
	 * 
	 * @param requestCode
	 * @param resultCode
	...
	public void saveImage(byte[]... png) {
		...
		File photo = new File(path, PICTURES_DIR + "BW" + image_name.toString()
				+ ".png");
		...
		try {
			...
			MultimediaManager.imagePath = imagePath;
